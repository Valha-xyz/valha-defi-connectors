export const InvestABI = [
  {
    inputs: [
      ...
      { internalType: 'address', name: '_cvx', type: 'address' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'minLpReceived', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'totalUnderlying_', type: 'uint256' },
      { internalType: 'uint256', name: 'totalAllocated_', type: 'uint256' },
      {
        internalType: 'uint256[]',
  ...
  {
    inputs: [{ internalType: 'address', name: 'curvePool', type: 'address' }],
    name: 'getWeight',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'address', name: 'curvePool_', type: 'address' }],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'maxDeviation_', type: 'uint256' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'conicLpAmount', type: 'uint256' },
      {
        internalType: 'uint256',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'newDepegThreshold_', type: 'uint256' },
    ],
