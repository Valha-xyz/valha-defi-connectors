export const MorphoABI = [
  ...
  { inputs: [], name: 'CompoundOracleFailed', type: 'error' },
  ...
  },
  {
    ...
    inputs: [
      {
        components: [
          { internalType: 'uint64', name: 'supply', type: 'uint64' },
          { internalType: 'uint64', name: 'borrow', type: 'uint64' },
          { internalType: 'uint64', name: 'withdraw', type: 'uint64' },
          { internalType: 'uint64', name: 'repay', type: 'uint64' },
        ],
        indexed: false,
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'bool', name: '_traded', type: 'bool' },
    ],
    name: 'RewardsClaimed',
    type: 'event',
  },
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: '_poolToken', type: 'address' },
      { internalType: 'uint256', name: '_amount', type: 'uint256' },
      { internalType: 'uint256', name: '_maxGasForMatching', type: 'uint256' },
    ],
    name: 'borrow',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'inP2P', type: 'uint256' },
      { internalType: 'uint256', name: 'onPool', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'claimRewards',
    outputs: [
      { internalType: 'uint256', name: 'amountOfRewards', type: 'uint256' },
    ],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'deltas',
    outputs: [
      { internalType: 'uint256', name: 'p2pSupplyDelta', type: 'uint256' },
      { internalType: 'uint256', name: 'p2pBorrowDelta', type: 'uint256' },
      { internalType: 'uint256', name: 'p2pSupplyAmount', type: 'uint256' },
      { internalType: 'uint256', name: 'p2pBorrowAmount', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'getHead',
    outputs: [{ internalType: 'address', name: 'head', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    name: 'getNext',
    outputs: [{ internalType: 'address', name: 'next', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_dustThreshold', type: 'uint256' },
      { internalType: 'uint256', name: '_maxSortedUsers', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint32', name: 'lastUpdateBlockNumber', type: 'uint32' },
      { internalType: 'uint112', name: 'lastSupplyPoolIndex', type: 'uint112' },
      { internalType: 'uint112', name: 'lastBorrowPoolIndex', type: 'uint112' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [
      { internalType: 'address', name: '_poolTokenBorrowed', type: 'address' },
      {
        internalType: 'address',
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'contract IPositionsManager', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'rewardsManager',
    outputs: [
      { internalType: 'contract IRewardsManager', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: '_poolToken', type: 'address' },
      { internalType: 'bool', name: '_isDeprecated', type: 'bool' },
    ],
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: '_poolToken', type: 'address' },
      { internalType: 'bool', name: '_isP2PDisabled', type: 'bool' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_newMaxSortedUsers', type: 'uint256' },
    ],
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: '_poolToken', type: 'address' },
      { internalType: 'uint16', name: '_p2pIndexCursor', type: 'uint16' },
    ],
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: '_poolToken', type: 'address' },
      { internalType: 'uint16', name: '_newReserveFactor', type: 'uint16' },
    ],
