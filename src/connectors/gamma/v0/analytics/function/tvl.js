...
async function checkGammaV0Tvl(chain, poolAddress) {
  try {
    ...
    const metadata = await poolContract.getTotalAmounts();
    ...
    const r0 = metadata.total0 / (10**decimals0);
    const r1 = metadata.total1 / (10**decimals1);
...
module.exports = checkGammaV0Tvl;
