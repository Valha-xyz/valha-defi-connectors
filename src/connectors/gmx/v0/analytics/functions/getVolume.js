...
export const SUBGRAPH_URLS = {
  arbitrum: "https://api.thegraph.com/subgraphs/name/messari/gmx-arbitrum",
  avalanche: "https://api.thegraph.com/subgraphs/name/messari/gmx-avalanche"
}
...
async function getVolume(chain, poolAddress) {
  try {
    ...
    const query = await queryGraphData(SUBGRAPH_URL,poolInfo.metadata.vault,currentBlock);
    const query7d = await queryGraphData(SUBGRAPH_URL,poolInfo.metadata.vault,block7d);
