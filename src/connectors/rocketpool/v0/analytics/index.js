...
const checkRocketV0Status = require('./functions/status');
const checkRocketV0TVL = require('./functions/tvl');
const checkRocketV0Liquidity = require('./functions/liquidity');
const checkRocketV0SharePrice = require('./functions/shareprice');
const checkRocketV0Minimum = require('./functions/minimum');
const checkRocketV0Maximum = require('./functions/maximum');
const checkRocketV0APY = require('./functions/apy');
