export const SWAPABI = [
  {
    inputs: [
      { internalType: 'address', name: '_synapseBridge', type: 'address' },
  ...
  },
  {
    ...
    name: 'addToken',
    outputs: [{ internalType: 'bool', name: 'wasAdded', type: 'bool' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    name: 'fee',
    outputs: [
      { internalType: 'uint40', name: 'bridgeFee', type: 'uint40' },
      { internalType: 'uint104', name: 'minFee', type: 'uint104' },
      { internalType: 'uint112', name: 'maxFee', type: 'uint112' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'removeToken',
    outputs: [{ internalType: 'bool', name: 'wasRemoved', type: 'bool' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    name: 'swapQuoter',
    outputs: [
      { internalType: 'contract ISwapQuoter', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'synapseBridge',
    outputs: [
      { internalType: 'contract ISynapseBridge', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
